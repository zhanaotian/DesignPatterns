 ...
 */
enum class EnumerationSingleton_kotlin {
    INSTANCE;
    //增加这个方法是让别人明白怎么使用，因为这种实现方式
    //还比较少见，限于java 1.5之后的版本
    val instance: com.jkwar.kotlin.singleton.EnumerationSingleton_kotlin
        get() = com.jkwar.kotlin.singleton.EnumerationSingleton_kotlin.INSTANCE
